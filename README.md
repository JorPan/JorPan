...
<ul>
  ...
  <li><b>Coding Skills:</b> TypeScript, JS, React, Next, Node, HTML, CSS, Ruby, Rails, Python</li>
  <li><b>Currently Learning:</b> AWS, Difinity, Internet Computer, Blockchain tech, Canvas & Sketch for visual fx programming  </li>
