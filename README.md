...
<ul>
  ...
  <li><b>Coding Skills:</b> TypeScript, JS, React, Node, HTML, CSS, Ruby, Rails, Python</li>
  <li><b>Currently Learning:</b> Difinity, Internet Computer, Blockchain tech, Next.JS, Canvas & Sketch for visual fx programming  </li>
